...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_CAPS] = LAYOUT_all(
        ...
        _______,   KC_6,    KC_7,       KC_8,    KC_9,    KC_0, _______, _______, _______, LV_AWOP, LV_AWCL, _______,   LV_EQ, _______,          MS_BTN1,
        _______,   KC_PGDN, KC_UP,   KC_PGUP, _______, _______, _______, _______, _______, _______, _______, _______, _______, LV_DDBS,          MS_BTN2,
    ...
    [WIN_FN] = LAYOUT_all(
        _______, KC_MYCM, KC_MAIL, KC_WSCH, KC_WHOM, KC_MSEL, _______, _______, DF(CHILD), QK_BOOT,  KC_NUM, _______, _______, _______,         LV_EMOTE,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,   KC_P0, RGB_SPD, RGB_SPI, _______,           UC_WIN,
        _______, _______, _______, _______, _______, _______, _______, _______, KC_INS,  _______, KC_PSCR, _______, _______, RGB_MOD,           UC_WINC,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, RGB_TOG, _______, _______,   KC_NO, RGB_HUI,           UC_LINX,
    ...
    [CHILD] = LAYOUT_all( /* Lily */
        KC_ESC,     KC_1,       KC_2,       KC_3,       KC_4,       KC_5,       KC_6,       KC_7,       KC_8,       KC_9,       KC_0,       KC_MINS,        KC_EQL,   KC_DEL,   LV_EMOTE,
        LSFT(KC_1), KC_1,       KC_2,       KC_3,       KC_4,       KC_5,       KC_6,       KC_7,       KC_8,       KC_9,       KC_0,       KC_MINS,        KC_EQL,   KC_BSPC,  UC(0x00D0),
        LSFT(KC_2), LSFT(KC_Q), LSFT(KC_W), LSFT(KC_E), LSFT(KC_R),	LSFT(KC_T),	LSFT(KC_Y),	LSFT(KC_U),	LSFT(KC_I),	LSFT(KC_O),	LSFT(KC_P),	KC_LBRC,        KC_RBRC,  KC_BSLS,  UC(0x2168),
        LSFT(KC_3), LSFT(KC_A), LSFT(KC_S), LSFT(KC_D), LSFT(KC_F),	LSFT(KC_G),	LSFT(KC_H),	LSFT(KC_J),	LSFT(KC_K),	LSFT(KC_L),	KC_SCLN,    KC_QUOT,        KC_NUHS,  KC_ENT,   UC(0x058E),
        LSFT(KC_4), KC_NUBS,    LSFT(KC_Z), LSFT(KC_X), LSFT(KC_C),	LSFT(KC_V),	LSFT(KC_B),	LSFT(KC_N),	LSFT(KC_M),	KC_COMM,    KC_DOT,     KC_SLSH,        KC_RSFT,  KC_UP,    UC(0x30C4),
        LSFT(KC_5), LSFT(KC_6), LSFT(KC_7),                   KC_SPC,                             KC_RGUI, MO(MAC_FN),  KC_RCTL,        KC_LEFT, KC_DOWN, KC_RGHT),
    ...
    [MAC_FN] = LAYOUT_all( /* Lily FN */
        _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   DF(WIN_B),  KC_F9,    KC_F10,  KC_F11,  KC_F12,  KC_DEL,            RGB_MOD,
